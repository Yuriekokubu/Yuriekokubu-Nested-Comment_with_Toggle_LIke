    ...
    <>
      <div className="comment">
        ...
        <div className="footer">
          <IconBtn onClick={onToggleCommentLike} Icon={likedByMe ? FaHeart : FaRegHeart} aria-label={likedByMe ? 'Unlike' : 'Like'}>
            {likeCount}
          </IconBtn>
          ...
          {user.id === currentUser.id && (
            <>
              ...
              <IconBtn onClick={onCommentDelete} disabled={deleteCommentFn.loading} Icon={FaTrash} aria-label="Delete" color="danger"></IconBtn>
            </>
          )}
        </div>
